 ...
 * @author LENOVO
 */
public class drugs1 extends javax.swing.JFrame {
public boolean doctor=false;
    /**
     * Creates new form drugs1
     */
    public drugs1() {
        initComponents();
        ...
        try{
            ...
            if((jTextField1.equals(""))||(jTextField2.equals(""))){
                ...
                myrs=myStmt.executeQuery("select did,quantity,description from drugs");
    ...
    private void initComponents() {
        ...
        jToggleButton2.setText("Show Available Drugs");
        ...
        setSize(new java.awt.Dimension(992, 459));
        setLocationRelativeTo(null);
    }// </editor-fold>//GEN-END:initComponents

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        int newq = Integer.parseInt(jTextField3.getText().trim());
        Connection myconn=null;
        Statement myStmt=null;
        ResultSet myrs=null;
        ...
        try{
            ...
            int quan = Integer.parseInt(array[1]);
            newq=newq+quan;

            // String query ="Select quantity from drugs where did = '"+did+"')";

            String query ="update drugs set  quantity= '"+newq+"'  where did = '"+did+"'";
            myStmt.executeUpdate(query);

            myrs=myStmt.executeQuery("select * from drugs");
            jTextArea1.setText("Did   Quantity   Desciption    \n");
            while(myrs.next()){
                jTextArea1.append(myrs.getString("did")+"       " + myrs.getString("quantity")+"               " + myrs.getString("description")+"\n");
            }
            choice1.removeAll();
            choice1.add("");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            if((jTextField1.equals(""))||(jTextField2.equals(""))){
                ...
                String query ="INSERT INTO drugs (quantity,description)  VALUES ('"+quantity+"','"+desc+"');";
                myStmt.executeUpdate(query);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(drugs1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
